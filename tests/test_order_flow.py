...
class TestOrderFlow:
    ...
    def test_logged_in_user_can_place_order(self, open_order_page):
    ...
    def test_order_details_popup_opens_on_click(self, open_order_page):
        order_page = open_order_page
    ...
    def test_user_orders_displayed_in_order_feed(self, web_driver, login_user):
    ...
    def test_total_orders_counter_increases(self, open_order_page):
        order_page = open_order_page
    ...
    def test_today_orders_counter_increases(self, open_order_page):
        order_page = open_order_page
    ...
    def test_order_number_appears_in_in_progress_section(self, open_order_page):
        order_page = open_order_page
        order_page.place_order()
        order_id = order_page.get_order_id()

        in_progress_page = InProgressPage(order_page.driver)
